...
#
# **Note**: Eventually, this notebook will be non-functional because the OPERA Cal Val system will be shut down and only the DAAC datasets will be available. The OPERA Cal Val system is simply the term used to refer to the collection of AWS services utilized for processing and storing the provisional datasets including the s3 bucket where these datasets are being saved.
